...
(function () {
var ctx;
    var backgroundColor='#fcf6f603';
var elCanvas = document.getElementById('space1');
...
function init() {
    ...
    ctx = document.getElementById('space1').getContext("2d"), particleCount = 20, particles = [], particleRadius = 5, minDist = 100, velocity = 1, colors = [
        {r: 117, g: 125, b: 175},
        {r: 68, g: 73, b: 102},
        {r: 248, g: 172, b: 19}
    ];
